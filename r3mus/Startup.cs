            ...
            return new CorsOptions
            {
                PolicyProvider = new CorsPolicyProvider
                {
                    PolicyResolver = context =>
                    {
                        ...
                        policy.Origins.Add("http://www.r3mus.org");
                        policy.Origins.Add("https://www.r3mus.org");
                        policy.Origins.Add("http://r3mus.space");
                        policy.Origins.Add("https://r3mus.space");
                        policy.Origins.Add("http://r3mus.org");
                        policy.Origins.Add("https://r3mus.org");
                        policy.Origins.Add("http://map.r3mus.space");
                        policy.Origins.Add("https://map.r3mus.space");
